{{-- resources/views/admin/create_admin.blade.php --}}

@extends('admin.dashboard')

@section('content')
    <div class="container bg-white p-8 rounded-lg shadow-md max-w-2xl mx-auto">
        <h1 class="text-3xl font-bold text-gray-800 mb-6 text-center">Buat Akun Admin Baru</h1>
        ...
        <form action="{{ route('admin.store') }}" method="POST" class="space-y-6">
            ...
            <div class="flex items-center justify-start space-x-4 mt-6">
                ...
                <a href="{{ route('statistik') }}" {{-- Atau rute lain yang relevan setelah membuat admin --}}
