...
@section('content')
    <div class="container bg-white p-8 rounded-lg shadow-md max-w-2xl mx-auto">
        <h1 class="text-3xl font-bold text-gray-800 mb-6 text-center">Edit Profil Admin</h1>
        ...
        <form action="{{ route('admin.profile.update') }}" method="POST" class="space-y-6">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama" id="nama" {{-- *** PERBAIKAN DI SINI (name="nama", id="nama") *** --}}
                    ...
                    value="{{ old('nama', $admin->nama) }}" required> {{-- *** PERBAIKAN DI SINI ($admin->nama) *** --}}
            </div>
            ...
            {{-- Bagian untuk mengubah/reset password --}}
            <div class="form-group">
                <label for="password" class="block text-gray-700 text-sm font-bold mb-2">Password Baru (kosongkan jika tidak
                    ingin diubah):</label>
            ...
            <div class="form-group">
                <label for="password_confirmation" class="block text-gray-700 text-sm font-bold mb-2">Konfirmasi Password
                    Baru:</label>
